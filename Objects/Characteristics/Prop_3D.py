...
# ==========================================
# 3. GENERATE 3D SECTIONS & FORMAT FOR MACRO
# ==========================================
catia_rows = []
# Ensure only 3 columns to match X, Y, Z formatting
