...
if __name__ == "__main__":
    ...
    weight_lst = [20.15, 10.85]                 # weights of the structure materials in Kg, assuming 65% carbon fiber, 35% polymer
    energy_consumption = 1500                # energy production of solar panels in W
    solar_panel_type = "GaAs" # type of solar panel used   
    battery_fuelcell = "battery"               # type of power source used
    consumption = 10.44                         # capacity of storage system in kWh for battery, or in KG H2 for fuel cell
    ...
    print(f"Total CO2 emissions: {total_co2_emissions} kgeq")