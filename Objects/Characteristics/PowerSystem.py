...
class power:                                                                       
    class solar:       
        def __init__(self,h,lat,A,x,days_from_solstice=0,powLimS=250,solar_efficiency=0.31,rhoS=0.25):
            ...
            def P(A,h,lat,days_from_solstice):
                ...
                self.avg_incidence = np.pi/2 - daylight_analysis.avg_incidence # converting to incidence angle wrt normal
            ...
            self.P = P(A,h,lat,days_from_solstice) # W, overall average power output during daylight hours

    class storage:
        def __init__(self, E, x, nr_of_cycles=0,DoD=80, E_m=450, E_vol=1150):
