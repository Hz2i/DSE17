...
def heat_conduction(Pow_req=1200.0, S=35.0):
    ...
    Q_heatengines = 2 * (k * S * 0.3 * delta_T / 4.5 ) / t # Heat transfer rate to account for by engines in worst case scenario in Watts

    Q_required = 2 * ((k * S * 0.3 * delta_T / 4.5 ) / t - Q_battery) # Required heat transfer rate in Watts
